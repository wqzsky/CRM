...
<body>
	...
	<div style="position:  relative; left: 30px;">t
		<h3>创建交易</h3>
	...
	<form action="workbench/transaction/save.do"  id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
                ...
                <input type="hidden" value="04fc02fc777b47cabe510c288d2e48ac" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
                ...
                <input type="hidden" value="30af471820ef4f0cbe739ac13183ac14" name="contactsId">
			</div>
		</div>
