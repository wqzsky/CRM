...
import com.muluo.crm.workbench.service.ClueService;
import com.muluo.crm.workbench.service.impl.ActivityServiceImpl;
import com.muluo.crm.workbench.service.impl.ClueServiceImpl;
...
public class ClueController extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("进入线索活动主控制器");

        String path = request.getServletPath();


        // 注意 / 和常量写前面
        if ("/workbench/clue/getUerList.do".equals(path)) {

            getUerList(request, response);
...
//        System.out.println(cid);
    ...
    private void getUerList(HttpServletRequest request, HttpServletResponse response) {
